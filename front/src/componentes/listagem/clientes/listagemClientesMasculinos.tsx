...
export default function ListagemClientesMasculinos({ tema }: Props) {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:3069/clientes/genero/Masculino")
      .then(res => res.json())
  ...
  return (
    <div className="row">
      <div className="col s10 offset-s1">
        <h4 className="center-align blue-text text-darken-2">Clientes do Gênero Masculino</h4>
          ...
          {clientes.map((cliente, index) => (
            <li key={index}>
              ...
              <div className="collapsible-body">
                ...
                <div className="section">
                  <h6 className="blue-text text-darken-2">RG(s)</h6>
                  <ul>
